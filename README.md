...
<img src="https://raw.githubusercontent.com/its-aathira/its-aathira/main/header (1).svg?v=2" alt="Aathira — AI · ML · Data Science" width="100%"/>
...
⭐ Custom evaluator · 25-question golden dataset · CI passing

</td>
<td width="50%" valign="top">

**[🧠 Reflecta](https://github.com/its-aathira)**

AI mental health chatbot powered by LLaMA3 via Groq API — empathetic, context-aware conversations with thoughtful response generation.

`Python` `LLaMA3` `Groq API` `Chatbot`

⭐ Emotionally intelligent · Low latency via Groq inference
